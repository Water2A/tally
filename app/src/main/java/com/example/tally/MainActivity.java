...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<AccountBean> list = DBManager.getAllAccountBeanFromAccounttb();
        for(int i=0;i<list.size();i++){
            AccountBean bean = list.get(i);
            Log.d("allDatas", "year" + bean.getYear() + "month" + bean.getMonth() +"day"+bean.getDay()+bean.getId()+"time"+bean.getTime());
        }
    }
    ...
    private void addLVHeaderView() {
        ...
        topbudgetTv = headerView.findViewById(R.id.item_mainlv_top_tv_budge);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.item_mainlv_top_tv_budge:
                showBudgeDialog();
                break;
            ...
            case R.id.main_btn_edit:
                Intent it1 = new Intent(MainActivity.this, RecordActivity.class);
                startActivity(it1);
                break;
    ...
    private void showBudgeDialog() {
        ...
        dialog.setOnEnsureListener(new BudgetDialog.OnEnsureListener() {
            ...
            public void onEnsure(float money) {
                ...
                //计算剩余金额
                float syMoney = money - DBManager.getSumMoneyOneMonth(year, month, 0);
                topbudgetTv.setText("￥"+syMoney);
            }
        });
    }
    ...
    boolean isShow=true;
    /**
     * 点击头布局眼睛时，如果原来时明文则加密，如果时密文，就显示出来
     */
