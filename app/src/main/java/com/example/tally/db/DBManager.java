...
import static com.example.tally.utils.FloatUtils.div;
...
public class DBManager {
    ...
    * */
    ...
    //获得数据库的所有数据进行测试
    public static List<AccountBean> getAllAccountBeanFromAccounttb(){
        List<AccountBean> list = new ArrayList<>();
